...
class Pogom(Flask):
    def __init__(self, import_name, **kwargs):
        ...
        self.route("/click", methods=['POST'])(self.post_clicked_location)
        self.route("/clicked_location", methods=['GET'])(self.get_clicked_location)
        

    def post_clicked_location(self):
        global stored
    ...
    def get_clicked_location(self):
        global stored
        print(stored[0], stored[1])
        print('json', jsonify(stored))
